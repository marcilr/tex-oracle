...
%%
%% oracle.tex
%% Created Mon 13 Jul 2020 11:13:44 AM AKDT
...
%%
\usepackage{svninfo}
\svnInfo $Id: oracle.tex 52 2013-02-04 22:32:54Z marcilr $
...
pdftitle={Oracle database, syntax, and usage},
pdfcreator={ps2pdf},
pdfsubject={Oracle, database, syntax, usage},
pdfkeywords={Oracle, database, syntax, usage}
]{hyperref}
...
\title{Oracle, database, syntax, usage}
